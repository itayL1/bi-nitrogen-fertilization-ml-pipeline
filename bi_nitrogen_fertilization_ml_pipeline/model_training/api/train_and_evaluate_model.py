...
from bi_nitrogen_fertilization_ml_pipeline.core.model_storage.api import store_trained_model
...
def train_and_evaluate_model(
    ...
    with setup_train_session_context(features_config, train_params) as session_context:
        ...
        store_trained_model(trained_model, session_context.artifacts, Path(output_model_file_path))
